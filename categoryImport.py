...
file_location ="C:/Users/sale/Documents/ChemFarmImports/categoryImportSQL/PythonAndOutput/" + file_name + ".xlsx"
...
# writing
with codecs.open(file_name + ".sql","w","utf-8-sig") as temp:
